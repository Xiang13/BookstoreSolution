        ...
        try {
            ...
            const res = await new Promise((resolve) => {
                setTimeout(() => {
                    resolve({
                        data: [
                            { categoryId: 1, categoryName: '文學小說', slug: 'literary-fiction' },
                            { categoryId: 2, categoryName: '科幻小說', slug: 'science-fiction' },
                            { categoryId: 3, categoryName: '歷史傳記', slug: 'history' },
                            { categoryId: 4, categoryName: '心理勵志', slug: 'psychology' },
                            { categoryId: 5, categoryName: '商業理財', slug: 'business' },
                        ]
                    })
                }, 300)
            })
